...
# Bing Webmaster Tools verification. Same rule as the IndexNow key above: Bing
# refetches this at the domain root and un-verifies the site if it 404s, which
# would silently drop the ChatGPT/Copilot-facing reporting surface.
cp BingSiteAuth.xml "$STAGE/"
